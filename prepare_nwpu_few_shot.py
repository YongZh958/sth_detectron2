...
#                'tvmonitor']
VOC_CLASSES = [
    'basketball','bridge', 'groundtrackfield', 'harbor', 'ship', 'storagetank',  'vehicle',
...
def parse_args():
    ...
    parser.add_argument("--seeds", type=int, nargs="+", default=[0, 1], #default=[1, 20],
                        help="Range of seeds")
...
def generate_seeds(args):
    ...
    for year in [2017]:
        data_file = 'datasets/NWPU{}/ImageSets/Main/trainval.txt'.format(year)
    ...
    for fileid in data:
        ...
        year = "2017"
        dirname = os.path.join("datasets", "NWPU{}".format(year))
    ...
    for i in range(args.seeds[0], args.seeds[1]):
        ...
        save_path = 'datasets/nwpusplit/seed{}'.format(i)
